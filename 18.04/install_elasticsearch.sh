...
call_function install_java "正在安裝 JAVA" ${LOG_PATH}
call_function install_es "正在安裝 elasticsearch" ${LOG_PATH}
call_function install_es_plugins "正在安裝 elasticsearch 套件" ${LOG_PATH}
